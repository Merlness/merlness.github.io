...
ttt_clojure.components.handle_submit = (function ttt_clojure$components$handle_submit(e){
e.preventDefault();
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),"Choose your Tic Tac Toe Options"], null),new cljs.core.PersistentVector(null, 17, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),(function (p1__13900_SHARP_){
return ttt_clojure.components.handle_submit.call(null,p1__13900_SHARP_);
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"Please choose which board you want to play with"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [ttt_clojure.components.radio_option,"3x3","size",new cljs.core.Keyword(null,"3x3","3x3",570362544),"3x3",(function (){
...
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"Please Select Player 1"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [ttt_clojure.components.radio_option,"human1","player_1",new cljs.core.Keyword(null,"human","human",-772334390),"human",(function (){
...
var and__4149__auto__ = cljs.core.some.call(null,(function (p1__13901_SHARP_){
return cljs.core._EQ_.call(null,index,p1__13901_SHARP_);
}),grid);
...
var vec__13902 = ttt_clojure.components.get_players.call(null,state,moves);
var current_player = cljs.core.nth.call(null,vec__13902,(0),null);
var opponent = cljs.core.nth.call(null,vec__13902,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4564__auto__ = (function ttt_clojure$components$make_grid_$_iter__13905(s__13906){
return (new cljs.core.LazySeq(null,(function (){
var s__13906__$1 = s__13906;
while(true){
var temp__5804__auto__ = cljs.core.seq.call(null,s__13906__$1);
if(temp__5804__auto__){
var s__13906__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__13906__$2)){
var c__4562__auto__ = cljs.core.chunk_first.call(null,s__13906__$2);
var size__4563__auto__ = cljs.core.count.call(null,c__4562__auto__);
var b__13908 = cljs.core.chunk_buffer.call(null,size__4563__auto__);
if((function (){var i__13907 = (0);
while(true){
if((i__13907 < size__4563__auto__)){
var index = cljs.core._nth.call(null,c__4562__auto__,i__13907);
cljs.core.chunk_append.call(null,b__13908,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [ttt_clojure.components.group_buttons,grid,side,index], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),index], null)));

var G__13909 = (i__13907 + (1));
i__13907 = G__13909;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__13908),ttt_clojure$components$make_grid_$_iter__13905.call(null,cljs.core.chunk_rest.call(null,s__13906__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__13908),null);
}
} else {
var index = cljs.core.first.call(null,s__13906__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [ttt_clojure.components.group_buttons,grid,side,index], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),index], null)),ttt_clojure$components$make_grid_$_iter__13905.call(null,cljs.core.rest.call(null,s__13906__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.game-result","div.game-result",-1250237605),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),ttt_clojure.ui.endgame_result.call(null,grid,"X","O")], null)], null);
} else {
return null;
}
});
...
var vec__13910 = ((cljs.core.odd_QMARK_.call(null,cljs.core.count.call(null,moves)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [player_2,"2"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [player_1,"1"], null));
var current_player = cljs.core.nth.call(null,vec__13910,(0),null);
var player_number = cljs.core.nth.call(null,vec__13910,(1),null);
...
ttt_clojure.components.ai_move_button = (function ttt_clojure$components$ai_move_button(current_player){
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"ai","ai",760454697),new cljs.core.Keyword(null,"kind","kind",-717265803).cljs$core$IFn$_invoke$arity$1(current_player))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex-center","div.flex-center",-2019004675),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"ai-move-btn",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return ttt_clojure.components.update_grid.call(null,(-1));
})], null),"AI Move"], null)], null);
} else {
return null;
}
});
ttt_clojure.components.in_progress_display = (function ttt_clojure$components$in_progress_display(grid,current_player){
if(cljs.core.not.call(null,ttt_clojure.board.game_over_QMARK_.call(null,grid,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"token","token",-1211463215),"X"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"token","token",-1211463215),"O"], null)))){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [ttt_clojure.components.turn_message,cljs.core.deref.call(null,ttt_clojure.components.game_state)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [ttt_clojure.components.ai_move_button,current_player], null)], null);
} else {
return null;
}
});
...
var vec__13913 = ttt_clojure.components.get_players.call(null,cljs.core.deref.call(null,ttt_clojure.components.game_state),moves);
var current_player = cljs.core.nth.call(null,vec__13913,(0),null);
var _ = cljs.core.nth.call(null,vec__13913,(1),null);
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),"Welcome to Merl's Tic Tac Toe"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [ttt_clojure.components.in_progress_display,grid,current_player], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [ttt_clojure.components.make_grid,grid,side], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [ttt_clojure.components.game_over_display,grid], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [ttt_clojure.components.new_game_button], null)], null);
});
ttt_clojure.components.tic_tac_toe = (function ttt_clojure$components$tic_tac_toe(){
var map__13916 = cljs.core.deref.call(null,ttt_clojure.components.game_state);
var map__13916__$1 = cljs.core.__destructure_map.call(null,map__13916);
var new_game = cljs.core.get.call(null,map__13916__$1,new cljs.core.Keyword(null,"new-game","new-game",167241648));
var size = cljs.core.get.call(null,map__13916__$1,new cljs.core.Keyword(null,"size","size",1098693007));
